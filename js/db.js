(function(){
  ...
  const StorageLocal = {
    ...
    async getSettings(){ const db = await getDB(); return (await db.get('settings','settings')) || { handsFreeEnabled:false, voiceEnabled:false, handsFreeSensitivity:0.4, handsFreePinchSensitivity:0.9, handsFreeMirrorX:true, voiceAnnouncements:true, sortMode:'series', theme:'dark' } },
