            ...
            <div class="settings-section handsfree">
              ...
              <div class="settings-row">
                ...
                <div class="range-wrap">
                  <input id="hf-sens" type="range" min="0" max="1" step="0.05" value="${s.handsFreeSensitivity ?? 0.4}" />
                  <span id="hf-sens-value" class="muted">${(Math.round(((s.handsFreeSensitivity ?? 0.4))*100))}%</span>
                </div>
              </div>
              <div class="settings-row">
                <label for="hf-pinch-sens">Pinch sensitivity</label>
                <div class="range-wrap">
                  <input id="hf-pinch-sens" type="range" min="0" max="1" step="0.05" value="${s.handsFreePinchSensitivity ?? 0.9}" />
                  <span id="hf-pinch-sens-value" class="muted">${(Math.round(((s.handsFreePinchSensitivity ?? 0.9))*100))}%</span>
                </div>
              </div>
            </div>
